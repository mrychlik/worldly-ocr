function plotConfMat(ax,varargin)
%PLOTCONFMAT plots the confusion matrix with colorscale, absolute numbers
%   and precision normalized percentages
%
%   usage: 
%   PLOTCONFMAT(ax, confmat) plots the confmat with integers 1 to n as class labels
%   PLOTCONFMAT(ax, confmat, labels) plots the confmat with the specified labels
%
%   Vahe Tshitoyan
%   20/08/2017
%
...
title(ax,sprintf('Accuracy: %.2f%%', 100*trace(confmat)/sum(confmat(:))));
ylabel(ax,'Output Class'); xlabel(ax,'Target Class');
