...
MNIST Digits Learner is an application which can be trained on
to recognize handwritten digits. The user can test its
accuracy by drawing digits with the mouse or using a tablet
and a pen. The training uses the famous 
